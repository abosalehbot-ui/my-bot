...
function _clearAuthLocals() {
    [
        'store_email', 'store_name', 'store_username', 'store_user_id',
        'store_avatar', 'bal_egp', 'bal_usd', STORE_PROFILE_TAB_KEY
...
async function openProfileModal() {
    ...
    if (!_isStoreLoggedIn() || !localStorage.getItem('store_email')) {
